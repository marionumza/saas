harpiya.define('partner_autocomplete.tests.dependencies', function (require) {
'use strict';
...
harpiya.define('partner_autocomplete.tests', function (require) {
    "use strict";
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "harpiya.com/logo.png" ? "harpiyabase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getHarpiyaSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getHarpiyaSuggestions(value);
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "harpiya")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "harpiya.com/logo.png"
                    || route === "data:image/png;base64,harpiyabase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "harpiya");
            ...
            assert.strictEqual($input.val(), "Harpiya", "Input value should have been updated to \"Harpiya\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "harpiya.com", "website value should have been updated to \"harpiya.com\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing harpiya letters again");
