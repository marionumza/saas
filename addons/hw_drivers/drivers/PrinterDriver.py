...
from harpiya.addons.hw_drivers.controllers.driver import event_manager, Driver, PPDs, conn, printers, cups_lock, iot_devices
from harpiya.addons.hw_drivers.tools import helpers
from harpiya.addons.hw_proxy.controllers.main import drivers as old_drivers
...
def print_star_error(deviceId):
    ...
    error_page = (
        ...
        "http://www.harpiya.com"  # TODO: Replace URL
        "\x0A\x0A"
