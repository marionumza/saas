...
class TestUi(tests.HttpCase):
    ...
    def test_course_member_employee(self):
        ...
        self.phantom_js(
            '/slides',
            'harpiya.__DEBUG__.services["web_tour.tour"].run("course_member")',
            'harpiya.__DEBUG__.services["web_tour.tour"].tours.course_member.ready',
...
class TestUiYoutube(tests.HttpCase):
    ...
    def test_course_member_yt_employee(self):
        ...
        self.phantom_js(
            '/slides',
            'harpiya.__DEBUG__.services["web_tour.tour"].run("course_member_youtube")',
            'harpiya.__DEBUG__.services["web_tour.tour"].tours.course_member_youtube.ready',
            login=user_demo.login)
    ...
    def test_course_publisher_website_designer(self):
        ...
        self.phantom_js(
            '/slides',
            'harpiya.__DEBUG__.services["web_tour.tour"].run("course_publisher")',
            'harpiya.__DEBUG__.services["web_tour.tour"].tours.course_publisher.ready',
            login=user_demo.login)
