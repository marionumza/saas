...
harpiya.define('website_slides.fullscreen', function (require) {
    'use strict';
        ...
        _preprocessSlideData: function (slidesDataList) {
            slidesDataList.forEach(function (slideData, index) {
                ...
                if (slideData.type === 'video') {
                    slideData.embedCode = $(slideData.embedCode).attr('src');  // embedCode containts an iframe tag, where src attribute is the url (youtube or embed document from harpiya)
