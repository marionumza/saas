...
copy_raspbian () {
    ...
    wget -c 'http://nightly.harpiya.com/master/posbox/iotbox/iotbox-latest.zip' -O raspbian/iotbox-latest.zip
    wget -c 'http://nightly.harpiya.com/master/posbox/iotbox/SHA1SUMS.txt' -O raspbian/SHA1SUMS.txt
    cd raspbian/
