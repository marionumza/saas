...
from harpiya.tools.misc import formatLang, get_lang
    ...
    def _amount_all(self):
        ...
        for order in self:
            ...
            if self.env.context.get('website_id'):
                ...
                if current_website.product_series:
        ...
        if self.env.context.get('website_id'):
            ...
            if current_website.product_series:
                for line in self:
                    ...
                    line.update({
                        'price_tax': sum(t.get('amount', 0.0) for t in taxes.get('taxes', [])) * series,
                        'price_total': taxes['total_included'] * series,
                        'price_subtotal': taxes['total_excluded'] * series,
                    })
