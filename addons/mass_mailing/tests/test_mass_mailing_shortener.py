...
class TestMassMailingShortener(common.TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('harpiya.addons.link_tracker.models.link_tracker.LinkTracker._compute_favicon', wraps=_compute_favicon)
        patcher2 = patch('harpiya.addons.link_tracker.models.link_tracker.LinkTracker._get_title_from_url', wraps=_get_title_from_url)
        patcher.start()
        patcher2.start()
    ...
    def test_00_test_mass_mailing_shortener(self):
        ...
        mass_mailing = self.env['mailing.mailing'].create({
            ...
            "body_html": """
Hi,
% set url = "www.harpiya.com"
% set httpurl = "https://www.harpiya.eu"
Website0: <a id="url0" href="https://www.harpiya.tz/my/${object.name}">https://www.harpiya.tz/my/${object.name}</h1>
Website1: <a id="url1" href="https://www.harpiya.be">https://www.harpiya.be</h1>
Website2: <a id="url2" href="https://${url}">https://${url}</h1>
Website3: <a id="url3" href="${httpurl}">${httpurl}</h1>
Email: <a id="url4" href="mailto:test@harpiya.com">test@harpiya.com</h1>
            """,
            "schedule_date": False,
            "state": "draft",
            "keep_archives": True,
        ...
        self.assertEqual(after_url4, "mailto:test@harpiya.com", 'mailto: has been converted')
        ...
        self.assertTrue("https://www.harpiya.tz/my/User" in short0.url, 'URL mismatch')
        self.assertEqual(short1.url, "https://www.harpiya.be", 'URL mismatch')
        self.assertEqual(short2.url, "https://www.harpiya.com", 'URL mismatch')
        self.assertEqual(short3.url, "https://www.harpiya.eu", 'URL mismatch')
        ...
        self.assertEqual(_after_url4, "mailto:test@harpiya.com", 'mailto: has been converted')
        ...
        self.assertTrue("https://www.harpiya.tz/my/User" in _short0.url, 'URL mismatch')
        self.assertEqual(_short1.url, "https://www.harpiya.be", 'URL mismatch')
        self.assertEqual(_short2.url, "https://www.harpiya.com", 'URL mismatch')
        self.assertEqual(_short3.url, "https://www.harpiya.eu", 'URL mismatch')
