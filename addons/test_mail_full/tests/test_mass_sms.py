...
from harpiya.addons.mass_mailing_sms.tests import common as mass_mailing_sms_common
from harpiya.addons.test_mail.tests import common as test_mail_common
