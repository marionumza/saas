harpiya.define('account.upload.bill.mixin', function (require) {
"use strict";
...
harpiya.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
harpiya.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
