...
from harpiya import models, api, _, fields
from harpiya.osv import expression
from harpiya.release import version
from harpiya.tools import DEFAULT_SERVER_DATE_FORMAT as DF, safe_eval
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                activities.append({
                    ...
                    'date': harpiya_format_date(self.env, activity.get('date_deadline'))
                })
