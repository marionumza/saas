...
from harpiya import api, fields, models, SUPERUSER_ID, tools
from harpiya.addons.resource.models.resource import float_to_time, HOURS_PER_DAY
    ...
    def create(self, values):
        ...
        if not self._context.get('leave_fast_create'):
            ...
            if leave_type.validation_type == 'no_validation':
                ...
                holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype="mt_comment") # Message from HarpiyaBot (sudo)
