...
from harpiya import fields, http, SUPERUSER_ID, tools, _
...
from harpiya.addons.payment.controllers.portal import PaymentProcessing
...
from harpiya.addons.website_form.controllers.main import WebsiteForm
...
class WebsiteSale(http.Controller):
    ...
    def checkout_form_validate(self, mode, all_form_values, data):
        ...
        if data.get('phone') and len(data.get('phone')) != 10:
            error["phone"] = 'error'
            error_message.append(_('Lütden 10 haneli telefon numaranızı girin.'))
