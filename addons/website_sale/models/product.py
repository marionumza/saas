...
class ProductTemplate(models.Model):
    ...
    wholesale_series = fields.Integer('Product Series', default=5)

    trendyol_entegrasyon = fields.Boolean('Trendyol Entegrasyon', default=False)
    hepsiburada_entegrasyon = fields.Boolean('Hepsiburada Entegrasyon', default=False)
    n11_entegrasyon = fields.Boolean('n11 Entegrasyon', default=False)
