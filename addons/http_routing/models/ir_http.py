...
import harpiya
from harpiya import api, models, registry, exceptions
from harpiya.addons.base.models.ir_http import RequestUID, ModelConverter
from harpiya.addons.base.models.qweb import QWebException
from harpiya.http import request
from harpiya.osv import expression
from harpiya.tools import config, ustr, pycompat
...
class IrHttp(models.AbstractModel):
    ...
    def _geoip_resolve(cls):
        if 'geoip' not in request.session:
            record = {}
            if harpiya._geoip_resolver and request.httprequest.remote_addr:
                record = harpiya._geoip_resolver.resolve(request.httprequest.remote_addr) or {}
