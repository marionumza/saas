...
from harpiya.modules import load_information_from_description_file
from harpiya.tools import convert_file, exception_to_unicode
from harpiya.tools.osutil import tempdir
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import harpiya.modules.module as module
                try:
                    harpiya.addons.__path__.append(module_dir)
                    ...
                    harpiya.addons.__path__.remove(module_dir)
