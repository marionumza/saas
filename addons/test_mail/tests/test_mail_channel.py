...
from harpiya.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('harpiya.addons.base.models.ir_model', 'harpiya.models', 'harpiya.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_channel', 'harpiya.models.unlink')
