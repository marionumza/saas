...
from harpiya.addons.test_mail.models.test_mail_models import MailTestGateway
from harpiya.addons.test_mail.tests.common import BaseFunctionalTest, MockEmails
from harpiya.addons.test_mail.tests.common import mail_new_test_user
from harpiya.tests import tagged
from harpiya.tools import email_split_and_format, mute_logger, pycompat, formataddr
...
class TestMailgateway(BaseFunctionalTest, MockEmails):
    ...
    @mute_logger('harpiya.addons.mail.models.mail_thread', 'harpiya.models', 'harpiya.addons.mail.models.mail_mail')
