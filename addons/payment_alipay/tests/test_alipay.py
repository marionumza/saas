...
from harpiya.addons.payment_alipay.controllers.main import AlipayController

@harpiya.tests.tagged('post_install', '-at_install', 'external', '-standard')
class AlipayTest(PaymentAcquirerCommon):
    ...
    @mute_logger('harpiya.addons.payment_alipay.models.payment', 'ValidationError')
