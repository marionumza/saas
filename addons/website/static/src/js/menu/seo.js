harpiya.define('website.seo', function (require) {
'use strict';
...
var MetaImageSelector = Widget.extend({
    ...
    init: function (parent, data) {
        ...
        data.pageImages.unshift(_.str.sprintf('/web/image/website/%s/logo', harpiya.session_info.website_id));
        data.pageImages.unshift(_.str.sprintf('/web/image/website/%s/social_default_image', harpiya.session_info.website_id));
