...
from harpiya.addons.http_routing.models.ir_http import slug, _guess_mimetype
from harpiya.addons.web.controllers.main import Binary
...
class WebsiteBinary(http.Controller):
    ...
    @http.route(['/favicon.png'], type='http', auth='public', website=True, multilang=False, sitemap=False)
    def favicon(self, **kw):
