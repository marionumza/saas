...
from harpiya.tools import remove_accents
...
class Alias(models.Model):
    ...
    alias_name = fields.Char('Alias Name', help="The name of the email alias, e.g. 'jobs' if you want to catch emails for <jobs@example.harpiya.com>")
    ...
    def name_get(self):
        """Return the mail alias display alias_name, including the implicit
           ...
           e.g. `jobs@mail.harpiya.com` or `jobs` or 'New Alias'
        """
        res = []
        for record in self:
