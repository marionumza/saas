harpiya.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isHarpiyabotAuthor()) {
            return '/mail/static/src/img/harpiyabot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or Harpiyabot messages
     * (note: Harpiyabot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isHarpiyabotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If Harpiyabot is the author (default author for transient messages),
     * returns 'Harpiyabot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is HarpiyaBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isHarpiyabotAuthor: function () {
        return this._serverAuthorID &&
            this._serverAuthorID[0] === this.call('mail_service', 'getHarpiyabotID')[0];
    },
    /**
