harpiya.define('mail.Manager', function (require) {
"use strict";
...
var MailManager =  AbstractService.extend({
    ...
    /**
     * Get the HarpiyaBot ID, which is the default authorID for transient messages
     *
     * @returns {Array<string>}
     */
    getHarpiyabotID: function () {
                ...
                if (
                    ...
                    if (thread.isTwoUserThread() && options.showNotification) {
                        ...
                        prom.then(function () {
                            ...
                            if (!self.call('bus_service', 'isHarpiyaFocused') || !query.isVisible) {
    ...
    _initializeInternalState: function () {
        ...
        // # of message received when harpiya is out of focus
    ...
    _notifyIncomingMessage: function (message) {
        if (this.call('bus_service', 'isHarpiyaFocused')) {
            // no need to notify
            return;
        }
