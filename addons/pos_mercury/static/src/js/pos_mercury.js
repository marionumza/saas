harpiya.define('pos_mercury.pos_mercury', function (require) {
"use strict";
...
PaymentScreenWidget.include({
    // How long we wait for the harpiya server to deliver the response of
        ...
        rpc.query({
            ...
            .then(function (data) {
                ...
                if (data === "internal error") {
                    def.resolve({
                        message: _t("Harpiya error while processing transaction.")
                    });
                    return;
                }
