...
from harpiya import models, api, service
from harpiya.tools.translate import _
from harpiya.exceptions import UserError
from harpiya.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "Harpiya " + service.common.exp_version()['server_version']
