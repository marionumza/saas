...
class SaleCouponProgram(models.Model):
    ...
    def _filter_on_mimimum_amount(self, order):
        ...
        for program in self:
            ...
            program_amount_min = program._compute_program_amount('rule_minimum_amount', order.currency_id)
            program_amount_max = program._compute_program_amount('rule_maximum_amount', order.currency_id)
            if program.rule_minimum_amount_tax_inclusion == 'tax_included' and program_amount_min <= (untaxed_amount + tax_amount) < program_amount_max or program.rule_minimum_amount_tax_inclusion == 'tax_excluded' and program_amount_min <= untaxed_amount < program_amount_max:
