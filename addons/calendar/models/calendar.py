...
from harpiya.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, pycompat
...
class Meeting(models.Model):
    ...
    def _rrule_parse(self, rule_str, data, date_start):
        ...
        #repeat yearly but for harpiya it's monthly, take same information as monthly but interval is 12 times
        if rule._bymonth:
