harpiya.define('im_support.systray.MessagingMenu', function (require) {
"use strict";
...
MessagingMenu.include({
    ...
    init: function () {
        ...
        this.supportChannel = {
            ...
            name: _t("Harpiya Live Support"),
            title: _t("Harpiya Live Support"),
            imageSRC: '/mail/static/src/img/harpiya_o.png',
        };
    },
    /**
