 ...
 * QUnit Config
 *
 * The Harpiya javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * Harpiya.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an Harpiya module, because we want this code to be executed
 * as soon as possible, not whenever the Harpiya module system feels like it.
 */
 ...
 * this is done outside of harpiya modules, otherwise the setting would not take
 * effect on time.
 */
...
async function checkModules() {
    ...
    await harpiya.__DEBUG__.didLogInfo;

    const info = harpiya.__DEBUG__.jsModules;
 ...
 */
QUnit.on('HarpiyaAfterTestHook', function () {
