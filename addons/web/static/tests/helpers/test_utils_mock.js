harpiya.define('web.test_utils_mock', function (require) {
"use strict";
 ...
 *   used to generate mock answers for every kind of routes supported by harpiya
 * @param {number} [params.debug] if set to true, logs RPCs and uncaught Harpiya
 *   events.
...
function addMockEnvironment(widget, params) {
    ...
    if ('config' in params) {
        ...
        if ('debug' in params.config) {
            harpiya.debug = params.config.debug;
        }
    }
    ...
    // make sure all Harpiya events bubbling up are intercepted
