harpiya.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that Harpiya actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute Harpiya actions, given as an ID in
     ...
     * @param {HarpiyaEvent} ev.data.controllerID
     */
