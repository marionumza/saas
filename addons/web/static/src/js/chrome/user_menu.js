harpiya.define('web.UserMenu', function (require) {
"use strict";
...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .guardedCatch(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.harpiya.com/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.harpiya.com/documentation/user', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.harpiya.com/buy', '_blank');
    },
    /**
     * @private
     */
