harpiya.define('web.upgrade_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    /**
     * Redirects the user to the harpiya-enterprise/uprade page
     *
     * @private
     * @returns {Promise}
     */
    _confirmUpgrade: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://www.harpiya.com/harpiya-enterprise/upgrade?num_users=" + data);
            });
    },
    /**
