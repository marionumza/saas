harpiya.define('web.basic_fields', function (require) {
"use strict";
...
var FieldDateRange = InputField.extend({
    ...
    _applyChanges: function (ev, picker) {
        ...
        if (this.isDateField) {
            ...
            // time at 00:00:00. So, Harpiya will consider it as UTC. To fix this added browser
