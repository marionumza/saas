harpiya.define('web.relational_fields', function (require) {
"use strict";
...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {HarpiyaEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend({
     ...
     * @override
     * @param {Object} record
     * @param {HarpiyaEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {HarpiyaEvent|MouseEvent} ev this event comes either from the 'Add
