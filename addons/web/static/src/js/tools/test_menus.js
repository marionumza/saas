(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = harpiya.__DEBUG__.services['web.AbstractController'];
        var Discuss = harpiya.__DEBUG__.services['mail.Discuss'];
        var WebClient = harpiya.__DEBUG__.services["web.WebClient"];
    ...
    function _clickEverywhere(menu_id){
        ...
        testedApps = [];
        testedMenus = [];
        var isEnterprise = harpiya.session_info.server_version_info[5] === 'e';
        // finding applications menus
        var $listOfAppMenuItems;
        if (isEnterprise) {
            console.log("Harpiya flavor: Enterprise");
            ...
            console.log("Harpiya flavor: Community");
            if (menu_id !== undefined) {
