harpiya.define('web.mvc', function (require) {
"use strict";

/**
 * This file contains a 'formalization' of a MVC pattern, applied to Harpiya
 * idioms.
 *
 * For a simple widget/component, this is definitely overkill.  However, when
 * working on complex systems, such as Harpiya views (or the control panel, or some
 ...
 * main issue is that the term 'View' is used way too much in Harpiya land, and
