harpiya.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Harpiya.
 *
 * The basic concurrency primitives in Harpiya JS are the callback, and the
