harpiya.define('web.ErrorDialogRegistry', function (require) {
"use strict";
...
harpiya.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = AbstractService.extend({
    ...
    show_error: function (error) {
        ...
        var dialog = new dialogClass(this, {
            title: _.str.capitalize(error.type) || _t("Harpiya Error"),
        }, error);
...
var RedirectWarningHandler = Widget.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new WarningDialog(this, {
            title: _.str.capitalize(error.type) || _t("Harpiya Warning"),
            buttons: [
...
core.crash_registry.add('harpiya.exceptions.RedirectWarning', RedirectWarningHandler);

function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("Harpiya Session Expired"), message: _t("Your Harpiya session expired. Please refresh the current web page.")});
        }
    };
}
core.crash_registry.add('harpiya.http.SessionExpiredException', session_expired);
