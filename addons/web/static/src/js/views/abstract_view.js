harpiya.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. Harpiya JS views are the
 ...
 * the word 'view' has historical significance in Harpiya code, so we replaced the
