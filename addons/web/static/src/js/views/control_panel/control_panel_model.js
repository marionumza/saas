harpiya.define('web.ControlPanelModel', function (require) {
"use strict";
    ...
    _getFilterContext: function (filter) {
        ...
        if (filter.type === 'field' && filter.isDefault) {
            if (this.fields[filter.attrs.name].type === 'many2one') {
                ...
                // https://github.com/harpiya/harpiya/blob/12.0/addons/web/static/src/js/views/search/search_inputs.js#L461)
