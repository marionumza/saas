harpiya.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether harpiya is focused or not
     *
     * @returns {boolean}
     */
    isHarpiyaFocused: function () {
        return this._isHarpiyaFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isHarpiyaFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isHarpiyaFocused);
        }
    },
    /**
