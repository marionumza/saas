...
from harpiya import registry as registry_get

from harpiya.addons.auth_signup.controllers.main import AuthSignupHome as Home
from harpiya.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
