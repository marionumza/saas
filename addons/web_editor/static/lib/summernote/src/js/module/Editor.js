define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // HARPIYA: allow access for override
    this.table = table;   // HARPIYA: allow access for override
    this.typing = typing; // HARPIYA: allow access for override
    this.bullet = bullet; // HARPIYA: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // HARPIYA: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // HARPIYA: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // HARPIYA: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // HARPIYA: addition
        $(anchor).css(linkInfo.style || {}); // HARPIYA: addition
        if (isNewWindow) {
