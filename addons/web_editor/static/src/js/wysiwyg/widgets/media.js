harpiya.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in harpiya.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" harpiya domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in harpiya.
 */
...
/**
 * Let users choose a document, including uploading a new document in harpiya.
 */
