...
from harpiya.tools import email_re, email_split
...
PLS_COMPUTE_BATCH_STEP = 50000  # harpiya.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
