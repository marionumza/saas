# Harpiya REST API
This is a module which expose Harpiya as a REST API 


## Installing
* Download this module and put it to your Harpiya addons directory
...
# Remember to configure default db on harpiya configuration file(dbfilter = ^db_name$)
