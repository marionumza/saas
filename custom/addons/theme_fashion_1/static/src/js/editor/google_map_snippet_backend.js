...
//--------------------------------------------------------------------------
harpiya.define('theme_fashion_1.google_map_snippet_backend',function(require) {
'use strict';
    ...
    var _t = core._t;
        var set_js_map_generate = options.Class.extend({
            ...
            popup_title: _t("Adres Bilgileri"),
            value_configure: function(type,value) {
                ...
                var def = wUtils.prompt({
                    ...
                    'init': function () {
                        ...
                        $group.find('input.form-control').before('<input class="location_selection_opt" id="static_loc" type="radio" name="radio_group" checked/> Manuel olarak girin<br/> <input class="location_selection_opt" id="dynamic_loc" type="radio" name="radio_group" /> Kullanılabilir Adresler');
                        $group.find('input.form-control').after('<div class="col-md-8 static_location d-none"><input class="static_location" type="text"/></div>');
                        $group.find('input.static_location').after("<span class='static_address_format_span static_location'><span class='show-format-span'>Adres veya Enlem ve Boylam aşağıdaki gibidir.</span><span class='address_span'>- M.Nesih Özmen Mh. No: 13 Güngören/İstanbul</span><span class='lat_long_span'>- 57.815637,101.137504</span></span>");
                        $group.append("<div class='google_map_size_div'><label class='col-md-4 col-form-label'>Harita Genişliği:</label><div class='width_div col-md-8'><input type='text' name='width' class='map_input_ele' value=''/> PX</div><label class='col-md-4 col-form-label'>Harita Yüksekliği:</label><div class='height_div col-md-8'><input type='text' name='height' class='map_input_ele' value=''/> PX</div></div>");
