...
def is_initialized(cr):
    ...
    """
    return harpiya.tools.table_exists(cr, 'ir_module_module')
...
def initialize(cr):
    ...
    """
    f = harpiya.modules.get_module_resource('base', 'data', 'base_data.sql')
    if not f:
    ...
    for i in harpiya.modules.get_modules():
        ...
        info = harpiya.modules.load_information_from_description_file(i)
