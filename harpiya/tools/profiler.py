...
class _LogTracer(object):
    ...
    def tracer(self, frame, event, arg):
        ...
        if not isinstance(in_self, harpiya.models.BaseModel):
            return self.tracer
...
def profile(method=None, whitelist=None, blacklist=(None,), files=None,
    ...
    """
        ...
        all methods for all harpiya models by applying the optional filters.
        ...
        :param list blacklist: list model names to remove from the log
                        (Default: remove non harpiya model from the log: [None])
        ...
        .. code-block:: python
          ...
          from harpiya.tools.profiler import profile
          ...
          class SaleOrder(models.Model):
            ...
            ...
            @profile()                  # log all methods for all harpiya models
            def unlink(self):
            ...
            @profile(whitelist=['sale.order', 'ir.model.data'])
            def action_quotation_send(self):
            ...
            @profile(files=['/home/openerp/harpiya/harpiya/addons/sale/models/sale.py'])
            def write(self):
            ...
    ...
    def _harpiyaProfile(method, *args, **kwargs):
    ...
    if not method:
        return lambda method: decorator(_harpiyaProfile, method)

    wrapper = decorator(_harpiyaProfile, method)
    return wrapper
