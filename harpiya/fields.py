...
class Field(MetaField('DummyField', (object,), {})):
    ...
    :param str group_operator: aggregate function used by :meth:`~harpiya.models.Model.read_group`
    ...
    def cache_key(self, env):
        ...
        def get(key, get_context=env.context.get):
            if key == 'force_company':
                ...
                # https://github.com/harpiya/harpiya/blob/4b06fe19fa68255b7982d15e5847da2f6d6209fd/addons/web/static/src/js/views/control_panel/control_panel_model.js#L962
...
class Image(Binary):
    ...
    :param bool verify_resolution: whether the image resolution should be verified
        ...
        See :class:`harpiya.tools.image.ImageProcess` for maximum image resolution (default: ``45e6``).
