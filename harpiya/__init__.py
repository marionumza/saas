...
#----------------------------------------------------------
# harpiya must be a namespace package for harpiya.addons to become one too
...
import sys
assert sys.version_info > (3, 6), "Outdated python version detected, Harpiya requires Python >= 3.6 to run."
...
from . import fields
from . import api
from harpiya.tools.translate import _, _lt
