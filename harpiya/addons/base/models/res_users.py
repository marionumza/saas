...
from harpiya.service.db import check_super
from harpiya.tools import partition, collections, lazy_property
        ...
        if self._on_login_cooldown(failures, previous):
            ...
            if ipaddress.ip_address(source).is_private:
                _logger.warn(
                    ...
                    "https://www.harpiya.com/documentation/13.0/setup/deploy.html#https for details.",
                    source
                )
