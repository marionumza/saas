...
import harpiya
from harpiya import api, http, models, tools, SUPERUSER_ID
from harpiya.exceptions import AccessDenied, AccessError
from harpiya.http import request, content_disposition
from harpiya.tools import consteq, pycompat
from harpiya.tools.mimetypes import guess_mimetype
from harpiya.modules.module import get_resource_path, get_module_path

from harpiya.http import ALLOWED_DEBUG_MODES
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(harpiya.conf.server_wide_modules)
            if tools.config['test_enable'] and harpiya.modules.module.current_test:
                installed.add(harpiya.modules.module.current_test)
