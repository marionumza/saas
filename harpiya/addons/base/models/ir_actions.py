...
import harpiya
from harpiya import api, fields, models, tools, SUPERUSER_ID, _
from harpiya.exceptions import MissingError, UserError, ValidationError, AccessError
from harpiya.osv import expression
from harpiya.tools.safe_eval import safe_eval, test_python_expr
from harpiya.tools import wrap_module
...
#  - env: Harpiya Environment on which the action is triggered
#  - model: Harpiya Model of the record on which the action is triggered; is a void recordset
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'Warning': harpiya.exceptions.Warning,
            # record
            'record': record,
            'records': records,
            # helpers
