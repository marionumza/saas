...
from harpiya.tools.misc import topological_sort
            ...
            if urls.get(OPENERP):
                ...
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'harpiya' subdirectory ?
                ...
                _logger.info('Copy downloaded module `harpiya` to `%s`', server_dir)
