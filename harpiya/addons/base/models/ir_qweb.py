...
from harpiya.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
...
from harpiya.addons.base.models.qweb import QWeb, Contextifier
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from harpiya.addons.web.controllers.main import module_boot
