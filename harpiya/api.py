...
"""The Harpiya API module defines Harpiya Environments and method decorators.
...
from harpiya.tools import frozendict, classproperty, lazy_property, StackMap
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~harpiya.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~harpiya.addons.base.models.res_users`"""
...
from harpiya.exceptions import UserError, AccessError, MissingError
